...
def dump_data(data, fn):
    with open(fn, 'w', encoding='utf-8') as f:
        for seq, query, y in data:
            ...
            print("{}\t{}\t{}".format(seq_str, query, y), file=f) #출력 내용을 f 객체에 입력
...
if __name__ == '__main__':
    ...
    os.makedirs(data_root, exist_ok=True) #exist_ok를 지정하면 폴더가 존재하지 않으면 생성하고, 존재하는 경우에는 아무것도 하지 않습니다.
